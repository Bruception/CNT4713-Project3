...
public class OFMatch implements Cloneable, Serializable {
    ...
    public String getNetworkDestinationCIDR() {
    	return IPv4.fromIPv4CIDRAddress(this.networkDestination, getNetworkDestinationMaskLen());
    }
    
    public String getNetworkSourceCIDR() {
    	return IPv4.fromIPv4CIDRAddress(this.networkSource, getNetworkSourceMaskLen());
    }
