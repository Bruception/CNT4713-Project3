...
public class IPv4 extends BasePacket {
 ...
 // Changes made using: https://github.com/andi-bigswitch/floodlight-oss/commit/98752d588cbc419566201de3d9dc19140f48c1ba
	...
	public static String fromIPv4CIDRAddress(int ipAddress, int cidrMaskBits) {
	StringBuilder sb = new StringBuilder();
	sb.append(fromIPv4Address(ipAddress));
	sb.append('/');
	sb.append(Math.max(0, Math.min(32, cidrMaskBits)));
	return sb.toString();
	}
